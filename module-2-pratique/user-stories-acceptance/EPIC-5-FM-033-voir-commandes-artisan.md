# US-EPIC-5-FM-033 : Voir mes commandes reçues (Template EPIC 5)
...
### Dépendances
- [x] EPIC-4-FM-28 : Passer commande (sinon pas de commandes à afficher)
...
Toutes les US de l'EPIC 5 (EPIC-5-FM-33 à EPIC-5-FM-37) partagent ces mêmes critères d'acceptation. Seuls changent :
- Le titre de l'US
